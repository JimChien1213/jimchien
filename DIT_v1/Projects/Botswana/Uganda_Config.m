...
conf.SimStart = datetime(2010,01,01); % Simulation starting date [yyyy,mm,dd]
conf.SimEnd = datetime(2020,12,31); % Simulation ending date [yyyy,mm,dd]
...
conf.irr.min = 0; % Minimum irrigation event [mm/event]     !1 by default
...
conf.irr.storage = 10; % Water storage(s) [mm/season]      !Will be sorted and duplicates removed
