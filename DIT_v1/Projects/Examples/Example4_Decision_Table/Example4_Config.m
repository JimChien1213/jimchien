...
%% Scenario settings
% General
conf.project = 'Example4_Decision_Table'; % The project name (same as project's folder name)
conf.saveas = 'Example4_Test_Run'; % The suffix of output files (e.g. MaizeOman)
...
%% Irrigation settings
conf.irr.strategy = 5; % 5 - Optimized deficit irrigation with decision table
