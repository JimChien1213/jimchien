...
% 21. Update total P and ET         % NEW CODE
NewCond.Pcum = NewCond.Pcum+P;
NewCond.ETcum = NewCond.ETcum+Et0;
...
if Irr > 0          % NEW CODE
   Outputs.irr_schedule = [AOS_InitialiseStruct.Outputs.irr_schedule; row_day Irr];
end
% Precipitation and ET          % NEW CODE
Ptot = NewCond.Pcum;
ETtot = NewCond.ETcum;
