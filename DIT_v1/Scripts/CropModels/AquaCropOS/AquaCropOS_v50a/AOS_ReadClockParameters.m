function [ClockStruct] = AOS_ReadClockParameters(conf) % ADJUSTED CODE
...
ClockStruct.SimulationStartDate = datenum(conf.SimStart); % NEW CODE
...
ClockStruct.SimulationEndDate = datenum(conf.SimEnd); % NEW CODE
